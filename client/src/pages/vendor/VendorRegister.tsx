      ...
      <div className="relative z-10 flex flex-col items-center px-4 py-12 w-full max-w-lg">
        ...
        <div className="w-full rounded-xl border border-primary-500/15 bg-black/40 shadow-2xl shadow-black/40 backdrop-blur-xl p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            {renderField('vendor-reg-password', 'password', 'password', '••••••••', 'Password', lockIcon, { show: showPassword, setShow: setShowPassword })}
            {renderField('vendor-reg-confirm', 'confirmPassword', 'password', '••••••••', 'Confirm Password', lockIcon, { show: showConfirmPassword, setShow: setShowConfirmPassword })}
