...
/* ========================================
   AddProduct — Vendor Add Product Form
   ======================================== */
    ...
    <VendorLayout>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-neutral-500 mb-3">
          ...
          <span className="text-neutral-400">Add Product</span>
        </div>
      ...
      <div className="max-w-2xl">
        <div className="bg-neutral-800 border border-neutral-700 rounded-xl p-6 sm:p-8">
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            {/* Product Name */}
            <FormField id="add-name" label="Product Name" error={showError('name')} required>
              <input
                id="add-name"
                name="name"
                type="text"
            ...
            {/* Description */}
            <FormField id="add-description" label="Description" error={showError('description')} required>
              <textarea
                id="add-description"
                name="description"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <FormField id="add-price" label="Price (₹)" error={showError('price')} required>
                <input
                  id="add-price"
                  name="price"
                  type="number"
              ...
              <FormField id="add-stock" label="Stock Quantity" error={showError('stock')}>
                <input
                  id="add-stock"
                  name="stock"
                  type="number"
            ...
            {/* Category */}
            <FormField id="add-category" label="Category" error={showError('category')} required>
              <select
                id="add-category"
                name="category"
                value={form.category}
